    ...
    return (
        ...
        <div className='row mt-3'>
            <div className="col-md-6 col-sm-6 pe-2 ps-2 ">
                <Card sx={{ minWidth: 275,minHeight:220, background: 'linear-gradient(45deg, #FFD24C 30%, #FFE69A  90%)', borderRadius: "16px" }}>
                    <CardContent>
                        <div className='row'>
                            <div className='col-6'>
            ...
            <div className="col-md-6 col-sm-6 pe-2 ps-2">
                <Card sx={{ minWidth: 275,minHeight:220, background: 'linear-gradient(45deg, #6867AC  30%, #4b6cb7  90%)', borderRadius: "16px" }}>
                    <CardContent>
                        <div className='row'>
                            <div className='col-6'>
                                <Typography color="white" variant="h3" component="div">
            ...
            <div className="col-md-6 col-sm-6 pe-2 ps-2 mt-3">
                <Card sx={{ minWidth: 275,minHeight:220, background: 'linear-gradient(45deg, #00C897 30%, #589340  90%)', borderRadius: "16px" }}>
                    <CardContent>
                        <div className='row'>
                            <div className='col-6'>
                                <Typography color="white" variant="h3" component="div">
            ...
            <div className="col-md-6 col-sm-6 pe-2 ps-2 mt-3">
                <Card sx={{ minWidth: 275,minHeight:220, background: 'linear-gradient(45deg, #e44d26 30%, #f16529  90%)', borderRadius: "16px" }}>
                    <CardContent>
                        <div className='row'>
                            <div className='col-6'>
                                <Typography color="white" variant="h3" component="div">
            ...
            <div className="col-md-6 col-sm-6 pe-2 ps-2 mt-3">
                <Card sx={{ minWidth: 275,minHeight:220, background: 'linear-gradient(45deg, #5463FF 30%, #5463FF  90%)', borderRadius: "16px" }}>
                    <CardContent>
                        <div className='row'>
                            <div className='col-6'>
                                <Typography color="white" variant="h3" component="div">
