                        ...
                        <div className='card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3'>
                            <div className="row feed-body ">
                                <div className="col-12 ">  
                                    <button style={{border:'none',}} className="p-2  bg-primary-gradiant  me-2 text-white text-center font-xssss fw-600 ls-1 rounded border-none"onClick={handleShow}>Create Super Deals</button> 
                                </div> 
                                </div>
                                                            ...
                                                            <ul className="   mt-1">
                                                                <li className="m-2 d-flex justify-content-evenly">
                                                                    ...
                                                                    <h4 className="fw-700 font-xs start-date">
                                                                        {moment(e.superDeals.start.iso).format("MMM Do YY")}{" "}
                                                                    </h4>
                                                                </li>
                                                                <li className="m-2 d-flex justify-content-evenly">
                                                                    <h3 className="font-s fw-500   text-grey-500 d-block">
                                                                    ...
                                                                    <h4 className="fw-700 font-xs start-date">
                                                                        {moment(e.superDeals.end.iso).format("MMM Do YY")}{" "}
                                                                    </h4>
                                                                </li>
                                                                <li className="m-2 d-flex justify-content-evenly">
                                                                    <h3 className="font-s fw-500   text-grey-500 d-block">
                                ...
                                <Modal show={show} onHide={handleClose} style={{ overflowY: 'scroll' }}>
                                    <Modal.Header className="theme-dark-bg" closeButton>
                                        <Modal.Title className="h4" style={{ fontWeight: "600" }}>Super Deals</Modal.Title>
                                    </Modal.Header>
                                        ...
                                        >
                                            ...
                                            <div className="form-group icon-input  p-2">
                                                <input onChange={(e) => setTitle(e.target.value)}
                                                    type="text" className=" h4 bor-0 w-100 rounded-xxl p-3 card text-grey-900 font-xsss fw-600 border-light-md" placeholder="Super Deal Title" />
                                            </div>
                                            ...
                                            <div className="form-group icon-input   p-2">
                                                <input onChange={(e) => setOffers(e.target.value)} type="text" className="h4 bor-0 w-100 rounded-xxl p-3    font-xsss fw-600 border-light-md card" placeholder="Offers" />
                                            </div>
                                            <div className="form-group icon-input   p-2">
                                                <input onChange={(e) => setEligiility(e.target.value)} type="text" className="h4 bor-0 w-100 rounded-xxl p-3    font-xsss fw-600 border-light-md card" placeholder="Eligibility" />
                                            </div>
