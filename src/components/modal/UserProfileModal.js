    ...
    return (
        <div className=" mx-1 " >
            ...
            >
                ...
                <List style={{ minWidth: '260px', padding: '0' }} className='theme-dark-bg p-0' >
                    <ListItem button  >
                        <ListItemAvatar>
                            <Avatar sx={{ bgcolor: blue[100], color: blue[600] }}>
                                <PersonIcon />
                        ...
                        <ListItemText className="h4" primary={user ? user.attributes.username : "user"} />
                    </ListItem>
                    <ListItem button onClick={handleClickItems} >
                        ...
                        <ListItemText className="h4" primary="Your Profile" />
                    </ListItem>
                    {/* <DarkMode /> */}
