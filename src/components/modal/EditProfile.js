...
export default function EditProfile() {
    ...
    return (
        <div className="">
            <ToastContainer />
            <a className="d-lg-block bg-success p-3 z-index-1 rounded-3 text-white font-xsssss text-uppercase fw-700 ls-3 cursor-pointer" onClick={handleOpen}>Edit Profile</a>
